// RogueEmblem - Main Game Loop
// Compile: g++ main.cpp Dice.cpp Entity.cpp Enemy.cpp Player.cpp CombatSystem.cpp Tile.cpp Board.cpp -o RogueEmblem -lsfml-graphics -lsfml-window -lsfml-system
...
int main() {
	...
	const int WINDOW_H = int(ROWS * TILE_SIZE + 160);
	...
	playerSprite.setScale(0.9f,0.9f);
